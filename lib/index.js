...
const deleteNode = (tree, key, high, id) => {
...
const addNode = (tree, key, high, id) => {
    let y = NULL_NODE;
    let x = tree.root;
    while (x !== NULL_NODE) {
        y = x;
...
const searchRecursive = (node, low, high, results) => {
